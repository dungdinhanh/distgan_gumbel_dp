...
if __name__ == '__main__':
    ...
    data_source = 'data/creditcardfraud/'
    ...
    if C == 0:
        ext_name = '%d_lr_%f_2dups_max_0.softmax_categorical_%d_tau_1.0_dups_50_50_50' % (n_steps, lr, categorical_softmax_use)
    else:
    ...
    if is_train == 0:
        ...
        distgan.generate()
        distgan.eval_acc(classifier='AdaBoostClassifier')
    elif is_train == 2:
        distgan.generate()
