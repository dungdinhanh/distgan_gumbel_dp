...
if __name__ == '__main__':
    ...
    out_dir = 'output/'
    db_name = 'fire_department_integer'
    data_source = 'data/fire_department/2016-categorical_dataset.csv'
    ...
    '''
    C     = 0    # clipping threshold of gradient. Assign C=0 with no DP
    ...
    if C == 0:
        ext_name = '%d_lr_%f_2dups_max_0.softmax_categorical_%d_tau_1.0_categoriesasinteger' % (n_steps, lr, categorical_softmax_use)
    else:
    ...
    distgan = DISTGAN(model=model, \
                              ...
                              dataset=dataset, \
                              n_steps = n_steps, \
                              out_dir=out_dir, batch_size=500)
