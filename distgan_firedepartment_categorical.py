...
if __name__ == '__main__':
    ...
    out_dir = 'output/'
    db_name = 'fire_department_categorical'
    data_source = 'data/fire_department/2016-categorical_dataset_1.csv'
    ...
    if C == 0:
        ext_name = '%d_lr_%f_2dups_max_0.softmax_categorical_%d_tau_1.0_fewerfeatures' % (n_steps, lr, categorical_softmax_use)
    else:
